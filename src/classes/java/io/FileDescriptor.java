...
/**
 * a simple abstraction for a file descriptor, which for us is little more than
 * just an id for a native data buffer (we don't want to keep the data itself in
 * the JPF space)
 * 
...
public class FileDescriptor {
	...
	String fileName;
	int mode; // no use to turn it into an Enum - it's accessed from the native
				// peer
	...
	FileDescriptor(String fname, int mode) throws IOException,

...
/**
 * MJI model class for java.io.RandomAccessFile This class cannot yet handle
 * File I/O correctly Some work about the use of RandomAccessFile can be found
 * here : https://bitbucket.org/pfjeau/jpf_for_nanohttpd/src/8f
 * 880ee27410026c69cf37f1904b159965d1576e/?at=raf-progress Another way to
 * implement all the missing features is to fix the jpf-bfs project in order to
 * handle file I/O
 * 
...
public class RandomAccessFile {
	...
	public native int read(byte[] data, int start, int len) throws IOException;

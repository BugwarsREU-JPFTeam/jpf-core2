 ...
 * real, platform VM specific version (it's native all over the place, its field
...
public final class Class<T> implements Serializable, GenericDeclaration, Type,
	...
	/**
	 * search global id of the corresponding ClassInfo, which factors in the
	 * classloader
	 */
	...
	public native Method getDeclaredMethod(String mthName,
	...
	public Package getPackage() {
		...
		if (idx >= 0) {
			...
			Package pkg = new Package(pkgName, "spectitle", "specversion",
					"specvendor", "impltitle", "implversion", "implvendor",
					null, getClassLoader());
			return pkg;

		} else { // weird, but there is no Package object for the default
					// package
			return null;
		}
	...
	public native Constructor<T> getConstructor(Class<?>... argTypes)
			throws NoSuchMethodException, SecurityException;
	...
	public static Class<?> forName(String clsName, boolean initialize,

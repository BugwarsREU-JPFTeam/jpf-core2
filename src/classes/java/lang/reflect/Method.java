...
/**
 * minimal Method reflection support. Note that we share peer code between
 * Method and Constructor (which aren't really different on the JPF side), so
...
public final class Method extends AccessibleObject implements Member {
	...
	public Object getDefaultValue() {
		throw new UnsupportedOperationException(
				"Method.getDefaultValue() not supported yet");
	}

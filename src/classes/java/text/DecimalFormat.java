 ...
 * to include all the delegation, but the real work should happen on the peer
 * side by forwarding to the real classes
 */
...
public class DecimalFormat extends NumberFormat implements Cloneable {
	 ...
	 * explicitly call the superclass ctors from the native peer (the 'id'
	 * handle gets initialized in the java.text.Format ctor)
	 */

...
/**
 * (incomplete) model class for java.text.Format the reason we model this is
 * that we want to cut off all the inner workings by just delegating to real
 * formatters stored in our native peer
 */
public abstract class Format {
	...
	public abstract StringBuffer format(Object o, StringBuffer sb,
			FieldPosition pos);

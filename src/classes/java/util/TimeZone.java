...
/**
 * a concrete TimeZone that forwards to the host VM. This is required to avoid
 * Java version compatibility problems Note that we drop the abstract modifier
 */
public class TimeZone implements Serializable, Cloneable {
	...
	// the public TimeZone() constructor of the original class can only be
	// called from the
	...
	public native int getOffset(int era, int year, int month, int day,
	...
	public native String getDisplayName(boolean daylight, int style,
			Locale locale);
}

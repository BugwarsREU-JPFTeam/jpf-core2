...
/**
 * listener for gov.nasa.jpf.Config changes. Implementors can register
 * themselves upon initialization, to react to downstream changes even if they
 * cache or process Config settings for increased performance.
 * 
...
public interface ConfigChangeListener {
	 ...
	 */
	void propertyChanged(Config conf, String key, String oldValue,
			String newValue);

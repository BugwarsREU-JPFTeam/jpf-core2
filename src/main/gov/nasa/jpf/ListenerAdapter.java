...
/**
 * Adapter class that dummy implements both VMListener and SearchListener
 * interfaces Used to ease implementation of listeners that only process a few
 * notifications
 */
public abstract class ListenerAdapter implements VMListener, SearchListener,
		PublisherExtension {

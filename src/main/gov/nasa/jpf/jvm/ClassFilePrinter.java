 ...
 */
public class ClassFilePrinter extends StructuredPrinter implements
		ClassFileReader {
	...
	public void setField(ClassFile cf, int fieldIndex, int accessFlags,
		...
		pw.printf("%s[%d]: %s, type=%s,flags=0x%X", indent, fieldIndex, name,
				descriptor, accessFlags);
	}

	@Override
	public void setFieldAttributeCount(ClassFile cf, int fieldIndex,
			int attrCount) {
	...
	@Override
	public void setFieldAttribute(ClassFile cf, int fieldIndex, int attrIndex,
	...
	public void setMethod(ClassFile cf, int methodIndex, int accessFlags,
			String name, String descriptor) {
		pw.printf("%s[%d]: %s%s, flags=0x%X", indent, methodIndex, name,
				descriptor, accessFlags);
	}

	@Override
	public void setMethodAttributeCount(ClassFile cf, int methodIndex,
			int attrCount) {
		pw.printf(", attr count=%d\n", attrCount);
		incIndent();
	}
	...
	@Override
	public void setCode(ClassFile cf, Object tag, int maxStack, int maxLocals,
			int codeLength) {
	...
	public void setExceptionHandler(ClassFile cf, Object tag,
		...
		pw.printf("%s[%d]: type=%s, range=[%d..%d], handler=%d\n", indent,
				exceptionIndex, catchType, startPc, endPc, handlerPc);
	}
	...
	public void setLocalVar(ClassFile cf, Object tag, int localVarIndex,
		...
		pw.printf("%s[%d]: %s, type=%s, scope=[%d..%d], slot=%d\n", indent,
				localVarIndex, varName, descriptor, scopeStartPc, scopeEndPc,
				slotIndex);
	}
	...
	public void setEnclosingMethod(ClassFile cf, Object tag,
			String enclosingClass, String enclosingMethod, String descriptor) {
		if (enclosingMethod != null) {
			pw.printf(", enclosingClass=%s, method=%s%s\n", enclosingClass,
					enclosingMethod, descriptor);
		} else {
	...
	public void setInnerClass(ClassFile cf, Object tag, int innerClsIndex,
		...
		pw.printf("%s[%d]: %s, fullName=%s, outerClass=%s, flags=0x%X\n",
				indent, innerClsIndex, innerSimpleName, innerName, outerName,
				accessFlags);
	}
	...
	@Override
	public void setAnnotation(ClassFile cf, Object tag, int annotationIndex,
	...
	public void setPrimitiveAnnotationValue(ClassFile cf, Object tag,
		...
		if (arrayIndex < 0) {
			pw.printf("%s[%d]: %s=%s\n", indent, annotationIndex, elementName,
					val);
		} else {
			if (arrayIndex == 0) {
	...
	public void setEnumAnnotationValue(ClassFile cf, Object tag,
		...
		if (arrayIndex < 0) {
			pw.printf("%s[%d]: %s=%s.%s\n", indent, annotationIndex,
					elementName, enumType, enumValue);
		} else {
			if (arrayIndex == 0) {
				pw.printf("%s[%d]: %s={", indent, valueIndex, elementName);
			} else {
	...
	@Override
	public void setAnnotationValuesDone(ClassFile cf, Object tag,
			int annotationIndex) {
		decIndent();
	}
	...
	void printRef(PrintWriter pw, ClassFile cf, int cpIdx, int dataPos,
			String refType) {
		pw.print(refType);
		pw.print(" {class=#");

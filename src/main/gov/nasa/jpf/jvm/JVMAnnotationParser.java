 ...
 * 
 * Java annotations form a different type system. Java annotations are
 * essentially restricted interfaces (no super-interface, no fields other than
 * static finals that are inlined by the compiler)
 * 
 ...
 */
public class JVMAnnotationParser extends ClassFileReaderAdapter implements
		AnnotationParser {
	...
	public void setInterface(ClassFile cf, int ifcIndex, String ifcName) {
		if (!"java/lang/annotation/Annotation".equals(ifcName)) {
			throw new JPFException("illegal annotation interface of: "
					+ annotationName + " is " + ifcName);
		}
	}

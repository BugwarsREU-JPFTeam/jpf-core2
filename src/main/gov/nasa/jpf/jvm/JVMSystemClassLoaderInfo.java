...
/**
 * a SystemClassLoaderInfo that reads standard Java classfiles from *.class and
 * *.jar files, and creates code using a concrete value JVM instruction set
 */
public class JVMSystemClassLoaderInfo extends SystemClassLoaderInfo {
	...
	protected JVMCodeBuilder createDefaultCodeBuilder(Config config, int appId) {
		...
		JVMInstructionFactory insnFactory = config.getEssentialInstance(key,
				JVMInstructionFactory.class);
	...
	/**
	 * this is the main method to create the ClassPath, which is called from the
	 * ctor
	 */
	@Override
	...
	/**
	 * override this if you have different CodeBuilders for different types NOTE
	 * - this CodeBuilder is not completely initialized yet, clients still have
	 * to call startMethod(mi) on it
	 */
	...
	/**
	 * used for automatically created code such as AnnotationProxies, direct
	 * calls, native calls and run starts NOTE - this cannot be called
	...
	@Override
	protected ClassInfo createClassInfo(String clsName, String url,

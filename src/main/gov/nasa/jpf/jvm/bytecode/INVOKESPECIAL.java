 ...
 * instance initialization method invocations ..., objectref, [arg1, [arg2 ...]]
 * => ...
 * 
...
public class INVOKESPECIAL extends InstanceInvocation {
	...
	public INVOKESPECIAL(String clsDescriptor, String methodName,
			String signature) {
	...
	public Instruction execute(ThreadInfo ti) {
		...
		// we don't have to check for NULL objects since this is either a ctor,
		// a
		...
		if (callee == null) {
			return ti.createAndThrowException(
					"java.lang.NoSuchMethodException", "Calling " + cname + '.'
							+ mname);
		}
	...
	public MethodInfo getInvokedMethod(ThreadInfo th) {
		...
		if (invokedMethod == null) {
			...
			boolean recursiveLookup = (mname.charAt(0) != '<'); // no hierarchy
																// lookup for
																// <init>

...
public class InstructionFactory extends JVMInstructionFactory {
	...
	public Object clone() {
		try {
			...
			throw new JPFException("InstructionFactory "
					+ this.getClass().getName() + " does not support cloning");
		}
	}
	...
	@Override
	public Instruction invokeinterface(String clsName, String methodName,
	...
	@Override
	public Instruction invokestatic(String clsName, String methodName,
			String methodSignature) {
		return new INVOKESTATIC(clsName, methodName, methodSignature);
	}

	@Override
	public Instruction invokevirtual(String clsName, String methodName,
			String methodSignature) {
	...
	@Override
	public Instruction putfield(String fieldName, String clsName,
			String fieldDescriptor) {

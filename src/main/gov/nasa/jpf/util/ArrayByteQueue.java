...
/**
 * It is a dynamically growing, cyclic array buffer queue for bytes. It has the
 * similar implementation as ArrayObjectQueue.
 * 
...
public class ArrayByteQueue implements ObjectQueue<Byte>, Cloneable {
	...
	@Override
	public void clear() {
		buffer = new byte[buffer.length]; // cheaper than iterating over the old
											// one
		size = 0;
		first = last = -1;
	}

 ...
 * 
 * The main motivation for this class is to minimize memory size while
 * maximizing performance and keeping a java.util.BitSet compatible interface.
 * The only deviation from the standard BitSet is that we assume more
 * cardinality() calls than set()/clear() calls, i.e. we want to cache this
 * value
 * 
...
public class BitSet1024 implements FixedBitSet, Cloneable {
	...
	public long getLong(int i) {
		...
		case 15:
			return l15;
		default:
			throw new IndexOutOfBoundsException("BitSet1022 has no long index "
					+ i);
		}
	}
	...
	public void set(int i) {
		if ((i & INDEX_MASK) == 0) {
			...
			throw new IndexOutOfBoundsException(
					"BitSet1024 index out of range: " + i);
		}
	}
	...
	public boolean get(int i) {
		...
		throw new IndexOutOfBoundsException("BitSet1024 index out of range: "
				+ i);
	}
	...
	@Override
	public void clear() {
		l0 = l1 = l2 = l3 = l4 = l5 = l6 = l7 = l8 = l9 = l10 = l11 = l12 = l13 = l14 = l15 = 0L;
		cardinality = 0;
	}
	...
	public int nextSetBit(int fromIdx) {
		if ((fromIdx & INDEX_MASK) == 0) {
			...
			switch (fromIdx >> 6) {
			case 0:
				if ((i = Long.numberOfTrailingZeros(l0
						& (0xffffffffffffffffL << i0))) < 64)
					return i;
				if ((i = Long.numberOfTrailingZeros(l1)) < 64)
					return i + 64;
				if ((i = Long.numberOfTrailingZeros(l2)) < 64)
					return i + 128;
				if ((i = Long.numberOfTrailingZeros(l3)) < 64)
					return i + 192;
				if ((i = Long.numberOfTrailingZeros(l4)) < 64)
					return i + 256;
				if ((i = Long.numberOfTrailingZeros(l5)) < 64)
					return i + 320;
				if ((i = Long.numberOfTrailingZeros(l6)) < 64)
					return i + 384;
				if ((i = Long.numberOfTrailingZeros(l7)) < 64)
					return i + 448;
				if ((i = Long.numberOfTrailingZeros(l8)) < 64)
					return i + 512;
				if ((i = Long.numberOfTrailingZeros(l9)) < 64)
					return i + 576;
				if ((i = Long.numberOfTrailingZeros(l10)) < 64)
					return i + 640;
				if ((i = Long.numberOfTrailingZeros(l11)) < 64)
					return i + 704;
				if ((i = Long.numberOfTrailingZeros(l12)) < 64)
					return i + 768;
				if ((i = Long.numberOfTrailingZeros(l13)) < 64)
					return i + 832;
				if ((i = Long.numberOfTrailingZeros(l14)) < 64)
					return i + 896;
				if ((i = Long.numberOfTrailingZeros(l15)) < 64)
					return i + 960;
				break;
			case 1:
				if ((i = Long.numberOfTrailingZeros(l1
						& (0xffffffffffffffffL << i0))) < 64)
					return i + 64;
				if ((i = Long.numberOfTrailingZeros(l2)) < 64)
					return i + 128;
				...
				break;
			case 2:
				if ((i = Long.numberOfTrailingZeros(l2
						& (0xffffffffffffffffL << i0))) < 64)
					return i + 128;
				if ((i = Long.numberOfTrailingZeros(l3)) < 64)
					return i + 192;
				...
				break;
			case 3:
				if ((i = Long.numberOfTrailingZeros(l3
						& (0xffffffffffffffffL << i0))) < 64)
					return i + 192;
				if ((i = Long.numberOfTrailingZeros(l4)) < 64)
					return i + 256;
				...
				break;
			case 4:
				if ((i = Long.numberOfTrailingZeros(l4
						& (0xffffffffffffffffL << i0))) < 64)
					return i + 256;
				if ((i = Long.numberOfTrailingZeros(l5)) < 64)
					return i + 320;
				...
				break;
			case 5:
				if ((i = Long.numberOfTrailingZeros(l5
						& (0xffffffffffffffffL << i0))) < 64)
					return i + 320;
				if ((i = Long.numberOfTrailingZeros(l6)) < 64)
					return i + 384;
				...
				break;
			case 6:
				if ((i = Long.numberOfTrailingZeros(l6
						& (0xffffffffffffffffL << i0))) < 64)
					return i + 384;
				if ((i = Long.numberOfTrailingZeros(l7)) < 64)
					return i + 448;
				...
				break;
			case 7:
				if ((i = Long.numberOfTrailingZeros(l7
						& (0xffffffffffffffffL << i0))) < 64)
					return i + 448;
				if ((i = Long.numberOfTrailingZeros(l8)) < 64)
					return i + 512;
				...
				break;
			case 8:
				if ((i = Long.numberOfTrailingZeros(l8
						& (0xffffffffffffffffL << i0))) < 64)
					return i + 512;
				if ((i = Long.numberOfTrailingZeros(l9)) < 64)
					return i + 576;
				...
				break;
			case 9:
				if ((i = Long.numberOfTrailingZeros(l9
						& (0xffffffffffffffffL << i0))) < 64)
					return i + 576;
				if ((i = Long.numberOfTrailingZeros(l10)) < 64)
					return i + 640;
				...
				break;
			case 10:
				if ((i = Long.numberOfTrailingZeros(l10
						& (0xffffffffffffffffL << i0))) < 64)
					return i + 640;
				if ((i = Long.numberOfTrailingZeros(l11)) < 64)
					return i + 704;
				...
				break;
			case 11:
				if ((i = Long.numberOfTrailingZeros(l11
						& (0xffffffffffffffffL << i0))) < 64)
					return i + 704;
				if ((i = Long.numberOfTrailingZeros(l12)) < 64)
					return i + 768;
				...
				break;
			case 12:
				if ((i = Long.numberOfTrailingZeros(l12
						& (0xffffffffffffffffL << i0))) < 64)
					return i + 768;
				if ((i = Long.numberOfTrailingZeros(l13)) < 64)
					return i + 832;
				...
				break;
			case 13:
				if ((i = Long.numberOfTrailingZeros(l13
						& (0xffffffffffffffffL << i0))) < 64)
					return i + 832;
				if ((i = Long.numberOfTrailingZeros(l14)) < 64)
					return i + 896;
				...
				break;
			case 14:
				if ((i = Long.numberOfTrailingZeros(l14
						& (0xffffffffffffffffL << i0))) < 64)
					return i + 896;
				if ((i = Long.numberOfTrailingZeros(l15)) < 64)
					return i + 960;
				break;
			case 15:
				if ((i = Long.numberOfTrailingZeros(l15
						& (0xffffffffffffffffL << i0))) < 64)
					return i + 960;
				break;
			}
	...
	public int nextClearBit(int fromIdx) {
		if ((fromIdx & INDEX_MASK) == 0) {
			...
			// throw new
			// IndexOutOfBoundsException("BitSet256 index out of range: " +
			// fromIdx);
			return -1;
		}
	}

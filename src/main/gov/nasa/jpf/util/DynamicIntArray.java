...
/**
 * simplistic dynamic array that differentiates from ArrayList by - using chunks
 * instead of exponential growth, thus efficiently dealing with sparse arrays -
...
public final class DynamicIntArray implements Iterable<Integer> {
	...
	public DynamicIntArray(int size) {
		this(Growth.defaultGrowth, DEFAULT_CHUNKBITS, (size
				+ (1 << DEFAULT_CHUNKBITS) - 1)
				/ (1 << DEFAULT_CHUNKBITS));
	}
	...
	/****************************
	 * debug & test ************ public void dump () { int i, j; for (i=0;
	 * i<data.length; i++) { System.out.print( "[" + i + "]: "); if (data[i] !=
	 * null) { System.out.print("{"); int l = data[i].length-1; for (j=0; j<l;
	 * j++) { System.out.print(data[i][j]); System.out.print(','); }
	 * System.out.print( data[i][j]); System.out.println("}"); } else {
	 * System.out.println( "null"); } } }
	 * 
	 * public static void main (String[] args) { int i; DynamicIntArray a = new
	 * DynamicIntArray(8);
	 * 
	 * a.set(0, 42); a.set(13,13); a.set(24, 42);
	 * 
	 * a.set(600, -1); System.out.println(a.get(599));
	 * System.out.println(a.get(600));
	 * 
	 * System.out.println( "--------- " + a.size()); //System.out.println(a);
	 * System.out.println(); System.out.println(); //a.dump(); }
	 * 
	 ***************************** end debug & test
	 *********/
}

...
/**
 * simplistic Object array that differentiates from ArrayList by using chunks
 * instead of exponential growth, thus efficiently dealing with huge,
 ...
 * it handles Objects, we could turn this into a Collection (and probably
 * should)
 * 
...
public final class DynamicObjectArray<E> implements Iterable<E> {
	...
	/**
	 * Creates a DynamicObjectArray in which each chunk has 2**chunkBits
	 * elements and initChunks chunks are initially allocated.
	 */

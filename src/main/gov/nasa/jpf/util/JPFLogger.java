 ...
 * 
 * We use this to avoid explicit Logger.isLoggable() checks in the code. The
 * goal is to avoid time & memory overhead if logging is not enabled.
 * 
 * We provide a fat interface to avoid Object[] creation for ellipsis method or
 * auto boxing for Object arguments
 * 
 */

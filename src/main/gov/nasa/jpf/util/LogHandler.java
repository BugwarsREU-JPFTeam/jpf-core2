...
/**
 * log handler class that deals with output selection and formatting. This is
 * the only handler we use for our own logging. We do our own little formatting
 * on the fly
 */
public class LogHandler extends Handler {
	...
	public LogHandler(Config conf) {
		...
		if (output.matches("[a-zA-Z0-9.]*:[0-9]*")) { // we assume that's a
														// hostname:port spec
		...
		} else if (output.equalsIgnoreCase("out")

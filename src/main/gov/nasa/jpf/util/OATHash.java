 ...
 * (http://www.burtleburtle.net/bob/hash/doobs.html), a simple yet sufficiently
 * avalanching hash that doesn't require a-priori knowledge of the key length
 * and is much faster than lookup3
 */

 ...
 * 
 * reset() has to be called at the beginning of a new run, causing all still
 * registered listeners to be notified. Listeners have to implement their own
 * logic to check for re-initialization, but can use the 'run' timestamp to do
 * so
 */

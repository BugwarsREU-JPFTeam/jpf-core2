 ...
 * 
 * - the number of elements does not have a hard limit - the number of elements
 * is assumed to be small, but potentially sparse - the following operations are
 * time critical + inclusion check + size check + cloning + iteration over
 * elements - adding/removing should be better than O(N)
 * 
 */

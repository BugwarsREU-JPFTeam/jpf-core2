...
/**
 * simple utility that can be used to check for string matches in sets with '*'
 * wildcards, e.g. to check for class name lists like
 * 
...
public class StringSetMatcher {
	 ...
	 * includes
	 */
	public static boolean isMatch(String s, StringSetMatcher includes,

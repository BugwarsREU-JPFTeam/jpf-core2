 ...
 * 
 * Since this is used in so many extensions from both model and native code, it
 * seems appropriate to add a basis implementation to util.
 * 
...
public class Automaton<S extends State> {
	...
	public String[] computeAlphabet() {
		for (int i = 0; i < nStates; i++) {
			...
			nextTransition: for (int j = 0; j < nTrans; j++) {

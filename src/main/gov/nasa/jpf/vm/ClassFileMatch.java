...
public abstract class ClassFileMatch {
	...
	// those are here because VM specific subclasses know about the binary
	// format, how to get the data from the
	// respective container, and what parser to use to transform it
	public abstract ClassInfo createClassInfo(ClassLoaderInfo loader)
			throws ClassParseException;

	public abstract AnnotationInfo createAnnotationInfo(ClassLoaderInfo loader)
			throws ClassParseException;

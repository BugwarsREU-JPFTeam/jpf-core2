...
public class DynamicElementInfo extends ElementInfo {
	...
	public DynamicElementInfo(int objref, ClassInfo ci, Fields f, Monitor m,
			ThreadInfo ti) {
	...
	protected FieldInfo getDeclaredFieldInfo(String clsBase, String fname) {
		return getClassInfo().getClassLoaderInfo()
				.getResolvedClassInfo(clsBase).getDeclaredInstanceField(fname);
	}
	...
	public boolean isBoxObject() {
		...
		if (cname.startsWith("java.lang.")) {
			...
			return ("Boolean".equals(cname) || "Character".equals(cname)
					|| "Byte".equals(cname) || "Short".equals(cname)
					|| "Integer".equals(cname) || "Float".equals(cname)
					|| "Long".equals(cname) || "Double".equals(cname));

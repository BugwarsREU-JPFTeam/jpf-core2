...
public interface Heap extends Iterable<ElementInfo> {
	...
	ElementInfo newSystemArray(String elementType, int nElements,
	...
	// (those are mostly used for their reference values since they already have
	// initialized fields,
	...
	ElementInfo newSystemThrowable(ClassInfo ci, String details,
			int[] stackSnapshot, int causeRef, ThreadInfo ti, int anchor);
	...
	// these update per-object counters - object will be gc'ed if it goes to
	// zero

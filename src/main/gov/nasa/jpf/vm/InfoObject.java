 ...
 * 
 * so far, it's used to factorize the annotation support, but we can also move
 * the attributes up here
 */
public abstract class InfoObject implements Cloneable {
	...
	/**
	 * user defined attribute objects. Note - this is not automatically state
	...
	// to be overridden by ClassInfo because of superclass inhertited
	// annotations

...
/**
 * stream to write program state info in a readable and diff-able format. This
 * is mostly intended for debugging, but could also at some point be used to
 * restore such states.
 * 
 * Currently supports heap objects, classes (static fields), threads and stack
 * frames
 */
public class JPFOutputStream extends OutputStream {
	...
	protected void printFields(ElementInfo ei, FieldInfo[] fields,

...
public class LocalVarInfo {
	...
	private String type; // lazy initialized FQN according to JLS 6.7 (e.g.
							// "int", "x.Y[]")
	private final String signature; // e.g. "I", "[Lx/Y;"
	private final String genericSignature; // non-type erased generic
											// signature(s)
	private final int startPC;
	private final int endPC;
	private final int slotIndex;

	public LocalVarInfo(String name, String signature, String genericSignature,
			int startPC, int endPC, int slotIndex) {

 ...
 * objects/classes, created by configured SharedObjectPolicy factory
 * 
 * Note - this class modified contents of instances, i.e. it does destructive
 * updates and hence has state carry-over between paths
 */
public class TidSet extends UnsortedArrayIntSet implements ThreadInfoSet,

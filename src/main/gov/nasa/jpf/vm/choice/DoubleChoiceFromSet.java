...
public class DoubleChoiceFromSet extends DoubleChoiceFromList {
	...
	/*
	 * Remove duplicate values. This is pretty redundant to IntChoiceFromSet,
	 * but unfortunately we rely on boxing/unboxing and array creation, for
	 * which the compiler needs the concrete type
	 */

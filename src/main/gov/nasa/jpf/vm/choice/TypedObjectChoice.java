 ...
 * This is a replacement for the old 'Verify.randomObject'
 */
public class TypedObjectChoice extends ChoiceGeneratorBase<Integer> implements
	...
	public TypedObjectChoice(Config conf, String id) {
		...
		if (type == null) {
			throw conf
					.exception("missing 'type' property for TypedObjectChoice "
							+ id);
		}

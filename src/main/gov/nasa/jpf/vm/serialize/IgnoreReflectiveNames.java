...
public class IgnoreReflectiveNames extends FieldAmmendmentByName {
	 ...
	 * also have int values that can be used to look up the name within the same
	 * VM execution.
	 */
	static final String[] reflectiveNameFields = { "java.lang.Class.name",
			"java.lang.reflect.Method.name", "java.lang.reflect.Field.name" };

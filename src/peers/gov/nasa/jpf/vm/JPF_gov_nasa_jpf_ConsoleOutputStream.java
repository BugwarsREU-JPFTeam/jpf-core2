...
/**
 * MJI NativePeer class to intercept all System.out and System.err printing. We
 * handle all of this native, since it's already slow enough
 */
public class JPF_gov_nasa_jpf_ConsoleOutputStream extends NativePeer {
	...
	public void $init____V(MJIEnv env, int objref) {
		// that's just a dummy because we have no OutputStream, which would
		// cause
	...
	@MJI
	public void print__Ljava_lang_String_2__V(MJIEnv env, int objRef, int strRef) {
	...
	@MJI
	public void write___3BII__V(MJIEnv env, int objRef, int bufRef, int off,
			int len) {

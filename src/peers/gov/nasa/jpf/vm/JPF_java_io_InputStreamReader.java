...
public class JPF_java_io_InputStreamReader extends NativePeer {
	...
	@MJI
	public int decode___3BI_3CIZ__I(MJIEnv env, int objref, int bref, int len,
			int cref, int off, boolean endOfInput) {
		int c = -1;
		int lim = in.limit();
	...
	public int decode__IZ__I(MJIEnv env, int objref, int b, boolean endOfInput) {
		...
		// this is terrible overhead to get a single char, I must be doing
		// something wrong..

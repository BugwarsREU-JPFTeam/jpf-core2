...
public class JPF_java_io_ObjectInputStream extends NativePeer {
	...
	@MJI
	public int latestUserDefinedLoader____Ljava_lang_ClassLoader_2(MJIEnv env,
			int clsRef) {
	...
	@MJI
	public void bytesToDoubles___3BI_3DII__(MJIEnv env, int clsRef, int baRef,
			int bOff, int daRef, int dOff, int nDoubles) {
	...
	@MJI
	public void bytesToFloats___3BI_3FII__(MJIEnv env, int clsRef, int baRef,
			int bOff, int faRef, int fOff, int nFloats) {

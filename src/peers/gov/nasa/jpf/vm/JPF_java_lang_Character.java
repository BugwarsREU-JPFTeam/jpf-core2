...
/**
 * MJI NativePeer class for java.lang.Character library abstraction Whoever is
 * using this seriously is definitely screwed, performance-wise
 */
public class JPF_java_lang_Character extends NativePeer {
	...
	public void $clinit____V(MJIEnv env, int clsObjRef) {
		...
		env.setStaticByteField("java.lang.Character", "UPPERCASE_LETTER",
				(byte) 1);
		env.setStaticByteField("java.lang.Character", "LOWERCASE_LETTER",
				(byte) 2);
		env.setStaticByteField("java.lang.Character", "TITLECASE_LETTER",
				(byte) 3);
		env.setStaticByteField("java.lang.Character", "MODIFIER_LETTER",
				(byte) 4);
		env.setStaticByteField("java.lang.Character", "OTHER_LETTER", (byte) 5);
		env.setStaticByteField("java.lang.Character", "NON_SPACING_MARK",
				(byte) 6);
		env.setStaticByteField("java.lang.Character", "ENCLOSING_MARK",
				(byte) 7);
		...
		env.setStaticByteField("java.lang.Character", "DECIMAL_DIGIT_NUMBER",
				(byte) 9);
		env.setStaticByteField("java.lang.Character", "LETTER_NUMBER",
				(byte) 10);
		env.setStaticByteField("java.lang.Character", "OTHER_NUMBER", (byte) 11);
		env.setStaticByteField("java.lang.Character", "SPACE_SEPARATOR",
				(byte) 12);
		env.setStaticByteField("java.lang.Character", "LINE_SEPARATOR",
				(byte) 13);
		...
		env.setStaticByteField("java.lang.Character", "DASH_PUNCTUATION",
				(byte) 20);
		env.setStaticByteField("java.lang.Character", "START_PUNCTUATION",
				(byte) 21);
		env.setStaticByteField("java.lang.Character", "END_PUNCTUATION",
				(byte) 22);
		...
		env.setStaticByteField("java.lang.Character", "CURRENCY_SYMBOL",
				(byte) 26);
		env.setStaticByteField("java.lang.Character", "MODIFIER_SYMBOL",
				(byte) 27);
	...
	@MJI
	public int valueOf__C__Ljava_lang_Character_2(MJIEnv env, int clsRef,
			char val) {

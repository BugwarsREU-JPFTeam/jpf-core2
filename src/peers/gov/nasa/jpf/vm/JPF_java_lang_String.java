...
public class JPF_java_lang_String extends NativePeer {
	...
	@MJI
	public int init___3CII__Ljava_lang_String_2(MJIEnv env, int objRef,
			int valueRef, int offset, int count) {
	...
	@MJI
	public int init___3III__Ljava_lang_String_2(MJIEnv env, int objRef,
			int codePointsRef, int offset, int count) {
	...
	@MJI
	public int init___3BIII__Ljava_lang_String_2(MJIEnv env, int objRef,
			int asciiRef, int hibyte, int offset, int count) {
	...
	@MJI
	public int init___3BIILjava_lang_String_2__Ljava_lang_String_2(MJIEnv env,
			int objRef, int bytesRef, int offset, int length, int charsetNameRef)
	...
	@MJI
	public int init___3BII__Ljava_lang_String_2(MJIEnv env, int objRef,
			int bytesRef, int offset, int length) {
		byte[] bytes = env.getByteArrayObject(bytesRef);
	...
	@MJI
	public int codePointCount__II__I(MJIEnv env, int objRef, int beginIndex,
			int endIndex) {
		String obj = env.getStringObject(objRef);
	...
	@MJI
	public int offsetByCodePoints__II__I(MJIEnv env, int objRef, int index,
			int codePointOffset) {
		String obj = env.getStringObject(objRef);
	...
	@MJI
	public void getChars__II_3CI__V(MJIEnv env, int objRef, int srcBegin,
			int srcEnd, int dstRef, int dstBegin) {
		String obj = env.getStringObject(objRef);
	...
	@SuppressWarnings("deprecation")
	@MJI
	public void getBytes__II_3BI__V(MJIEnv env, int objRef, int srcBegin,
			int srcEnd, int dstRef, int dstBegin) {
		String obj = env.getStringObject(objRef);
	...
	@MJI
	public int getBytes__Ljava_lang_String_2___3B(MJIEnv env, int objRef,
			int charSetRef) {
	...
	@MJI
	public boolean equals0___3C_3CI__Z(MJIEnv env, int clsObjRef,
			int charsRef1, int charsRef2, int len) {
	...
	@MJI
	public boolean equals__Ljava_lang_Object_2__Z(MJIEnv env, int objRef,
			int argRef) {
	...
	@MJI
	public boolean equalsIgnoreCase__Ljava_lang_String_2__Z(MJIEnv env,
			int objref, int anotherString) {
		String thisString = env.getStringObject(objref);
		if (anotherString != MJIEnv.NULL) {
			return thisString.equalsIgnoreCase(env
					.getStringObject(anotherString));
		} else {
			return false;
		}
	}
	...
	@MJI
	public int compareTo__Ljava_lang_String_2__I(MJIEnv env, int objRef,
	...
	@MJI
	public int MJIcompare__Ljava_lang_String_2Ljava_lang_String_2__I(
			MJIEnv env, int clsRef, int s1Ref, int s2Ref) {
	...
	@MJI
	public boolean regionMatches__ILjava_lang_String_2II__Z(MJIEnv env,
			int objRef, int toffset, int otherRef, int ooffset, int len) {
		String obj = env.getStringObject(objRef);
	...
	public boolean regionMatches__ZILjava_lang_String_2II__Z(MJIEnv env,
			int objRef, boolean ignoreCase, int toffset, int otherRef,
			int ooffset, int len) {
		String obj = env.getStringObject(objRef);
		String other = env.getStringObject(otherRef);
	...
	@MJI
	public boolean startsWith__Ljava_lang_String_2I__Z(MJIEnv env, int objRef,
			int prefixRef, int toffset) {
	...
	@MJI
	public boolean startsWith__Ljava_lang_String_2__Z(MJIEnv env, int objRef,
			int prefixRef) {
		String thisStr = env.getStringObject(objRef);
		String prefix = env.getStringObject(prefixRef);
	...
	@MJI
	public int indexOf__Ljava_lang_String_2I__I(MJIEnv env, int objref,
	...
	@MJI
	public int lastIndexOf__Ljava_lang_String_2I__I(MJIEnv env, int objref,
			int str, int fromIndex) {
		String thisStr = env.getStringObject(objref);
		String indexStr = env.getStringObject(str);
	...
	@MJI
	public int substring__I__Ljava_lang_String_2(MJIEnv env, int objRef,
			int beginIndex) {
		String obj = env.getStringObject(objRef);
	...
	@MJI
	public int substring__II__Ljava_lang_String_2(MJIEnv env, int objRef,
	...
	@MJI
	public int concat__Ljava_lang_String_2__Ljava_lang_String_2(MJIEnv env,
			int objRef, int strRef) {
		Heap heap = env.getHeap();

		ElementInfo thisStr = heap.get(objRef);
		CharArrayFields thisFields = (CharArrayFields) heap.get(
				thisStr.getReferenceField("value")).getFields();
		char[] thisChars = thisFields.asCharArray();
		int thisLength = thisChars.length;

		ElementInfo otherStr = heap.get(strRef);
		CharArrayFields otherFields = (CharArrayFields) heap.get(
				otherStr.getReferenceField("value")).getFields();
	...
	@MJI
	public int replace__CC__Ljava_lang_String_2(MJIEnv env, int objRef,
	...
	@MJI
	public boolean matches__Ljava_lang_String_2__Z(MJIEnv env, int objRef,
			int regexRef) {
	...
	@MJI
	public int replaceFirst__Ljava_lang_String_2Ljava_lang_String_2__Ljava_lang_String_2(
			MJIEnv env, int objRef, int regexRef, int replacementRef) {
		String thisStr = env.getStringObject(objRef);
	...
	@MJI
	public int replaceAll__Ljava_lang_String_2Ljava_lang_String_2__Ljava_lang_String_2(
			MJIEnv env, int objRef, int regexRef, int replacementRef) {
		String thisStr = env.getStringObject(objRef);
		String regexStr = env.getStringObject(regexRef);
		String replacementStr = env.getStringObject(replacementRef);
	...
	@MJI
	public int split__Ljava_lang_String_2I___3Ljava_lang_String_2(MJIEnv env,
			int clsObjRef, int strRef, int limit) {
	...
	@MJI
	public int split__Ljava_lang_String_2___3Ljava_lang_String_2(MJIEnv env,
			int clsObjRef, int strRef) {
		String s = env.getStringObject(strRef);
		String obj = env.getStringObject(clsObjRef);
	...
	@MJI
	public int toLowerCase__Ljava_util_Locale_2__Ljava_lang_String_2(
			MJIEnv env, int objRef, int locRef) {
		String s = env.getStringObject(objRef);
	...
	@MJI
	public int toUpperCase__Ljava_util_Locale_2__Ljava_lang_String_2(
			MJIEnv env, int objRef, int locRef) {
		String s = env.getStringObject(objRef);
		Locale loc = JPF_java_util_Locale.getLocale(env, locRef);
	...
	@MJI
	public int format__Ljava_lang_String_2_3Ljava_lang_Object_2__Ljava_lang_String_2(
			MJIEnv env, int clsObjRef, int fmtRef, int argRef) {
		return env.newString(env.format(fmtRef, argRef));
	}

	@MJI
	public int format__Ljava_util_Locale_2Ljava_lang_String_2_3Ljava_lang_Object_2__Ljava_lang_String_2(
			MJIEnv env, int clsObjRef, int locRef, int fmtRef, int argRef) {
		Locale loc = JPF_java_util_Locale.getLocale(env, locRef);
	...
	public int intern____Ljava_lang_String_2(MJIEnv env, int robj) {
		// <2do> Replace this with a JPF space HashSet once we have a String
		// model
		Heap heap = env.getHeap();

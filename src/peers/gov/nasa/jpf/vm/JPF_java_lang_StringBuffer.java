...
public class JPF_java_lang_StringBuffer extends NativePeer {
	...
	int appendString(MJIEnv env, int objref, String s) {
		...
		if (n < alen) {
			...
			for (i = 0; i < count; i++) {
				env.setCharArrayElement(arefNew, i,
						env.getCharArrayElement(aref, i));
			}
			for (j = 0; i < n; i++, j++) {
	...
	/*
	 * public static int append__Ljava_lang_StringBuffer_2 (MJIEnv env, int
	 * objref, int sbref) { int vref = env.getReferenceField(sbref, "value");
	 * int sbCount = env.getIntField(sbref, "count");
	 * 
	 * // how braindead, how lazy char[] b = env.getCharArrayObject(vref);
	...
	@MJI
	public int append__Ljava_lang_String_2__Ljava_lang_StringBuffer_2(
	...
	@MJI
	public int append__I__Ljava_lang_StringBuffer_2(MJIEnv env, int objref,
			int i) {
	...
	@MJI
	public int append__F__Ljava_lang_StringBuffer_2(MJIEnv env, int objref,
			float f) {
	...
	@MJI
	public int append__D__Ljava_lang_StringBuffer_2(MJIEnv env, int objref,
			double d) {
	...
	@MJI
	public int append__J__Ljava_lang_StringBuffer_2(MJIEnv env, int objref,
			long l) {
	...
	@MJI
	public int append__Z__Ljava_lang_StringBuffer_2(MJIEnv env, int objref,
			boolean b) {
	...
	/*
	 * public static int append__B__Ljava_lang_StringBuffer_2 (MJIEnv env, int
	 * objref, byte b) { return append__C__Ljava_lang_StringBuffer_2(env,
	 * objref, (char)b); }
	 */

	@MJI
	public int append__C__Ljava_lang_StringBuffer_2(MJIEnv env, int objref,
			char c) {
		int aref = env.getReferenceField(objref, "value");
		int alen = env.getArrayLength(aref);
		int count = env.getIntField(objref, "count");

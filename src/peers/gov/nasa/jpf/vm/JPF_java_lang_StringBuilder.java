...
public class JPF_java_lang_StringBuilder extends NativePeer {
	...
	// This is only justified because StringBuilders are used everywhere
	// (implicitly)
	@MJI
	...
	@MJI
	public int append__I__Ljava_lang_StringBuilder_2(MJIEnv env, int objref,
			int i) {
	...
	@MJI
	public int append__F__Ljava_lang_StringBuilder_2(MJIEnv env, int objref,
			float f) {
	...
	@MJI
	public int append__D__Ljava_lang_StringBuilder_2(MJIEnv env, int objref,
			double d) {
	...
	@MJI
	public int append__J__Ljava_lang_StringBuilder_2(MJIEnv env, int objref,
			long l) {
	...
	@MJI
	public int append__Z__Ljava_lang_StringBuilder_2(MJIEnv env, int objref,
			boolean b) {
	...
	@MJI
	public int append__C__Ljava_lang_StringBuilder_2(MJIEnv env, int objref,
			char c) {
		int aref = env.getReferenceField(objref, "value");
		int alen = env.getArrayLength(aref);
		int count = env.getIntField(objref, "count");

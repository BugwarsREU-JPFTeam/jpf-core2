...
public class JPF_java_lang_Throwable extends NativePeer {
	/**
	 * return array of StackTraceElement elements from the snapshot stored in
	 * the Throwable
	 */
	@MJI
	public int createStackTrace_____3Ljava_lang_StackTraceElement_2(MJIEnv env,
			int objref) {
	...
	@MJI
	public int getStackTraceAsString____Ljava_lang_String_2(MJIEnv env,
			int objRef) {
		ThreadInfo ti = env.getThreadInfo();

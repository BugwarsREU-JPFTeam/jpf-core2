...
/**
 * (incomplete) native peer for SimpleDateFormat. See Format for details about
 * native formatter delegation
 */
public class JPF_java_text_SimpleDateFormat extends NativePeer {
	...
	@MJI
	public void init0__II__V(MJIEnv env, int objref, int timeStyle,
			int dateStyle) {
		// we are lost here - can't call this SimpleDateFormat ctor because it's
		// package private
		// (this is called - and has to be intercepted - from the
		// DateFormat.getInstance() factory)

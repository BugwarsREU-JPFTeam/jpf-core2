 ...
 */
public class JPF_java_util_concurrent_atomic_AtomicReferenceFieldUpdater extends
		AtomicFieldUpdater {

	@MJI
	public void $init__Ljava_lang_Class_2Ljava_lang_Class_2Ljava_lang_String_2__V(
			MJIEnv env, int objRef, int tClsObjRef, int fClsObjRef, int fNameRef) {
	...
	public boolean weakCompareAndSet__Ljava_lang_Object_2Ljava_lang_Object_2Ljava_lang_Object_2__Z(
			MJIEnv env, int objRef, int tRef, int fExpect, int fUpdate) {
		return (compareAndSet__Ljava_lang_Object_2Ljava_lang_Object_2Ljava_lang_Object_2__Z(
				env, objRef, tRef, fExpect, fUpdate));
	}

	@MJI
	public void set__Ljava_lang_Object_2Ljava_lang_Object_2__(MJIEnv env,
			int objRef, int tRef, int fNewValue) {
	...
	@MJI
	public void lazySet__Ljava_lang_Object_2Ljava_lang_Object_2__(MJIEnv env,
			int objRef, int tRef, int fNewValue) {
		set__Ljava_lang_Object_2Ljava_lang_Object_2__(env, objRef, tRef,
				fNewValue);
	}

...
public class JPF_sun_misc_Unsafe extends NativePeer {
	...
	public int getUnsafe____Lsun_misc_Unsafe_2(MJIEnv env, int clsRef) {
		int objRef = env
				.getStaticReferenceField("sun.misc.Unsafe", "theUnsafe");
		return objRef;
	}

	@MJI
	public long objectFieldOffset__Ljava_lang_reflect_Field_2__J(MJIEnv env,
			int unsafeRef, int fieldRef) {
		return fieldOffset__Ljava_lang_reflect_Field_2__I(env, unsafeRef,
				fieldRef);
	}
	 ...
	 */
	@MJI
	public int fieldOffset__Ljava_lang_reflect_Field_2__I(MJIEnv env,
			int unsafeRef, int fieldRef) {
	...
	public boolean compareAndSwapObject__Ljava_lang_Object_2JLjava_lang_Object_2Ljava_lang_Object_2__Z(
			MJIEnv env, int unsafeRef, int objRef, long fieldOffset,
			int expectRef, int updateRef) {
		int actual = getObject__Ljava_lang_Object_2J__Ljava_lang_Object_2(env,
				unsafeRef, objRef, fieldOffset);
		if (actual == expectRef) {
			putObject__Ljava_lang_Object_2JLjava_lang_Object_2__V(env,
					unsafeRef, objRef, fieldOffset, updateRef);
			return true;
		}
		return false;
	}
	...
	@MJI
	public boolean compareAndSwapInt__Ljava_lang_Object_2JII__Z(MJIEnv env,
			int unsafeRef, int objRef, long fieldOffset, int expect, int update) {
		int actual = getInt__Ljava_lang_Object_2J__I(env, unsafeRef, objRef,
				fieldOffset);
		if (actual == expect) {
			putInt__Ljava_lang_Object_2JI__V(env, unsafeRef, objRef,
					fieldOffset, update);
			return true;
		}
		return false;
	...
	@MJI
	public boolean compareAndSwapLong__Ljava_lang_Object_2JJJ__Z(MJIEnv env,
			int unsafeRef, int objRef, long fieldOffset, long expect,
			long update) {
		long actual = getLong__Ljava_lang_Object_2J__J(env, unsafeRef, objRef,
				fieldOffset);
		if (actual == expect) {
			putLong__Ljava_lang_Object_2JJ__V(env, unsafeRef, objRef,
					fieldOffset, update);
			return true;
		}
		return false;
	...
	@MJI
	public void park__ZJ__V(MJIEnv env, int unsafeRef, boolean isAbsoluteTime,
			long timeout) {
		...
		if (ti.isFirstStepInsn()) { // re-executed
			...
			// assert ti.getLockObject() == null :
			// "private 'permit' object locked";
			...
			if (ei.getBooleanField("blockPark")) { // we have to wait, but don't
													// need a lock
				...
				ChoiceGenerator<?> cg = env.getSchedulerFactory().createParkCG(
						ei, ti, isAbsoluteTime, timeout);
				env.setMandatoryNextChoiceGenerator(cg,
						"no CG on blocking park()");
	...
	@MJI
	public void unpark__Ljava_lang_Object_2__V(MJIEnv env, int unsafeRef,
			int objRef) {
		ThreadInfo ti = env.getThreadInfo();
		...
		if (!ti.isFirstStepInsn()) {
			...
			if (tiParked.getLockObject() == eiPermit) {
				...
				ChoiceGenerator<?> cg = env.getSchedulerFactory()
						.createUnparkCG(tiParked);
				if (cg != null) {
	...
	@MJI
	public void ensureClassInitialized__Ljava_lang_Class_2__V(MJIEnv env,
			int unsafeRef, int clsObjRef) {
	...
	@MJI
	public int getObject__Ljava_lang_Object_2J__Ljava_lang_Object_2(MJIEnv env,
			int unsafeRef, int objRef, long fieldOffset) {
	...
	@MJI
	public int getObjectVolatile__Ljava_lang_Object_2J__Ljava_lang_Object_2(
			MJIEnv env, int unsafeRef, int objRef, long fieldOffset) {
		return getObject__Ljava_lang_Object_2J__Ljava_lang_Object_2(env,
				unsafeRef, objRef, fieldOffset);
	}

	@MJI
	public void putObject__Ljava_lang_Object_2JLjava_lang_Object_2__V(
			MJIEnv env, int unsafeRef, int objRef, long fieldOffset, int valRef) {
	...
	@MJI
	public void putObjectVolatile__Ljava_lang_Object_2JLjava_lang_Object_2__V(
			MJIEnv env, int unsafeRef, int objRef, long fieldOffset, int valRef) {
		putObject__Ljava_lang_Object_2JLjava_lang_Object_2__V(env, unsafeRef,
				objRef, fieldOffset, valRef);
	}
	...
	@MJI
	public boolean getBooleanVolatile__Ljava_lang_Object_2J__Z(MJIEnv env,
			int unsafeRef, int objRef, long fieldOffset) {
		return getBoolean__Ljava_lang_Object_2J__Z(env, unsafeRef, objRef,
				fieldOffset);
	}
	...
	@MJI
	public void putBooleanVolatile__Ljava_lang_Object_2JZ__V(MJIEnv env,
			int unsafeRef, int objRef, long fieldOffset, boolean val) {
		putBoolean__Ljava_lang_Object_2JZ__V(env, unsafeRef, objRef,
				fieldOffset, val);
	}

	@MJI
	public byte getByte__Ljava_lang_Object_2J__B(MJIEnv env, int unsafeRef,
	...
	@MJI
	public byte getByteVolatile__Ljava_lang_Object_2J__B(MJIEnv env,
			int unsafeRef, int objRef, long fieldOffset) {
		return getByte__Ljava_lang_Object_2J__B(env, unsafeRef, objRef,
				fieldOffset);
	}
	...
	@MJI
	public void putByteVolatile__Ljava_lang_Object_2JB__V(MJIEnv env,
			int unsafeRef, int objRef, long fieldOffset, byte val) {
		putByte__Ljava_lang_Object_2JB__V(env, unsafeRef, objRef, fieldOffset,
				val);
	}

	@MJI
	public char getChar__Ljava_lang_Object_2J__C(MJIEnv env, int unsafeRef,
			int objRef, long fieldOffset) {
		ElementInfo ei = env.getElementInfo(objRef);
		if (!ei.isArray()) {
			FieldInfo fi = getRegisteredFieldInfo(fieldOffset);
	...
	@MJI
	public char getCharVolatile__Ljava_lang_Object_2J__C(MJIEnv env,
			int unsafeRef, int objRef, long fieldOffset) {
		return getChar__Ljava_lang_Object_2J__C(env, unsafeRef, objRef,
				fieldOffset);
	}
	...
	@MJI
	public void putCharVolatile__Ljava_lang_Object_2JC__V(MJIEnv env,
			int unsafeRef, int objRef, long fieldOffset, char val) {
		putChar__Ljava_lang_Object_2JC__V(env, unsafeRef, objRef, fieldOffset,
				val);
	}

	@MJI
	public short getShort__Ljava_lang_Object_2J__S(MJIEnv env, int unsafeRef,
			int objRef, long fieldOffset) {
		ElementInfo ei = env.getElementInfo(objRef);
		if (!ei.isArray()) {
			FieldInfo fi = getRegisteredFieldInfo(fieldOffset);
	...
	@MJI
	public short getShortVolatile__Ljava_lang_Object_2J__S(MJIEnv env,
			int unsafeRef, int objRef, long fieldOffset) {
		return getShort__Ljava_lang_Object_2J__S(env, unsafeRef, objRef,
				fieldOffset);
	}
	...
	@MJI
	public void putShortVolatile__Ljava_lang_Object_2JS__V(MJIEnv env,
			int unsafeRef, int objRef, long fieldOffset, short val) {
		putShort__Ljava_lang_Object_2JS__V(env, unsafeRef, objRef, fieldOffset,
				val);
	}
	...
	@MJI
	public int getIntVolatile__Ljava_lang_Object_2J__I(MJIEnv env,
			int unsafeRef, int objRef, long fieldOffset) {
		return getInt__Ljava_lang_Object_2J__I(env, unsafeRef, objRef,
				fieldOffset);
	}
	...
	@MJI
	public void putIntVolatile__Ljava_lang_Object_2JI__V(MJIEnv env,
			int unsafeRef, int objRef, long fieldOffset, int val) {
		putInt__Ljava_lang_Object_2JI__V(env, unsafeRef, objRef, fieldOffset,
				val);
	}
	...
	@MJI
	public float getFloat__Ljava_lang_Object_2J__F(MJIEnv env, int unsafeRef,
			int objRef, long fieldOffset) {
		ElementInfo ei = env.getElementInfo(objRef);
		if (!ei.isArray()) {
			FieldInfo fi = getRegisteredFieldInfo(fieldOffset);
	...
	@MJI
	public float getFloatVolatile__Ljava_lang_Object_2J__F(MJIEnv env,
			int unsafeRef, int objRef, long fieldOffset) {
		return getFloat__Ljava_lang_Object_2J__F(env, unsafeRef, objRef,
				fieldOffset);
	}
	...
	@MJI
	public void putFloatVolatile__Ljava_lang_Object_2JF__V(MJIEnv env,
			int unsafeRef, int objRef, long fieldOffset, float val) {
		putFloat__Ljava_lang_Object_2JF__V(env, unsafeRef, objRef, fieldOffset,
				val);
	}

	@MJI
	public long getLong__Ljava_lang_Object_2J__J(MJIEnv env, int unsafeRef,
			int objRef, long fieldOffset) {
		ElementInfo ei = env.getElementInfo(objRef);
		if (!ei.isArray()) {
			FieldInfo fi = getRegisteredFieldInfo(fieldOffset);
	...
	@MJI
	public long getLongVolatile__Ljava_lang_Object_2J__J(MJIEnv env,
			int unsafeRef, int objRef, long fieldOffset) {
		return getLong__Ljava_lang_Object_2J__J(env, unsafeRef, objRef,
				fieldOffset);
	}
	...
	@MJI
	public void putLongVolatile__Ljava_lang_Object_2JJ__V(MJIEnv env,
			int unsafeRef, int objRef, long fieldOffset, long val) {
		putLong__Ljava_lang_Object_2JJ__V(env, unsafeRef, objRef, fieldOffset,
				val);
	}

	@MJI
	public void putOrderedLong__Ljava_lang_Object_2JJ__V(MJIEnv env,
			int unsafeRef, int objRef, long fieldOffset, long val) {
		putLong__Ljava_lang_Object_2JJ__V(env, unsafeRef, objRef, fieldOffset,
				val);
	}
	...
	@MJI
	public double getDouble__Ljava_lang_Object_2J__D(MJIEnv env, int unsafeRef,
			int objRef, long fieldOffset) {
		ElementInfo ei = env.getElementInfo(objRef);
		if (!ei.isArray()) {
			FieldInfo fi = getRegisteredFieldInfo(fieldOffset);
	...
	@MJI
	public double getDoubleVolatile__Ljava_lang_Object_2J__D(MJIEnv env,
			int unsafeRef, int objRef, long fieldOffset) {
		return getDouble__Ljava_lang_Object_2J__D(env, unsafeRef, objRef,
				fieldOffset);
	}
	...
	@MJI
	public void putDoubleVolatile__Ljava_lang_Object_2JD__V(MJIEnv env,
			int unsafeRef, int objRef, long fieldOffset, double val) {
		putDouble__Ljava_lang_Object_2JD__V(env, unsafeRef, objRef,
				fieldOffset, val);
	}

	@MJI
	public int arrayBaseOffset__Ljava_lang_Class_2__I(MJIEnv env,
			int unsafeRef, int clazz) {
		return 0;
	}

	@MJI
	public int arrayIndexScale__Ljava_lang_Class_2__I(MJIEnv env,
			int unsafeRef, int clazz) {
		return 1;
	}

	private static FieldInfo getRegisteredFieldInfo(long fieldOffset) {
		return JPF_java_lang_reflect_Field
				.getRegisteredFieldInfo((int) fieldOffset);
	}
	...
	static class Alloc {
		...
		public String toString() {
			return String.format("Alloc[objRef=%x,startAdr=%x,endAdr=%x]",
					objRef, startAdr, endAdr);
		}
	}
	...
	public long allocateMemory__J__J(MJIEnv env, int unsafeRef, long nBytes) {
		if (nBytes < 0 || nBytes > Integer.MAX_VALUE) {
			env.throwException("java.lang.IllegalArgumentException",
					"invalid memory block size: " + nBytes);
			return 0;
		}
	...
	public void freeMemory__J__V(MJIEnv env, int unsafeRef, long startAddress) {
		...
		if (startAddress != MJIEnv.NULL) {
			...
			if (a == null) {
				env.throwException("java.lang.IllegalArgumentException",
						"invalid memory address: " + Integer.toHexString(addr));
			} else {

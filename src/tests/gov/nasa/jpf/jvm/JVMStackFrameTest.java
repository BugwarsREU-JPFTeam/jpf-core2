...
public class JVMStackFrameTest extends TestJPF {
	...
	public void testDup2_x1_Attrs() {
		...
		assert frame.getTopPos() == 4;
		assert frame.peek(4) == 2 && frame.getOperandAttr(4) == "2"; // same
																		// const
																		// pool
																		// string
	...
	public void testDup2_x2_Attrs() {
		...
		assert frame.getTopPos() == 5;
		assert frame.peek(5) == 3 && frame.getOperandAttr(5) == "3"; // same
																		// const
																		// pool
																		// string
	...
	public void testPushLong() {
		...
		Object obj_Long = frame.getLocalValueObject(new LocalVarInfo(
				"testLong", "J", "J", 0, 0, 0));
	...
	public void testPushDouble() {
		...
		Object obj_Double = frame.getLocalValueObject(new LocalVarInfo(
				"testDouble", "D", "D", 0, 0, frame.getTopPos() - 1));

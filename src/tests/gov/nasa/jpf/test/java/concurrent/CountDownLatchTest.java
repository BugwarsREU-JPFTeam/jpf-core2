...
public class CountDownLatchTest extends TestJPF {
	...
	private static final int N = 2; // Too many states to test if set higher
									// than 2. jpf-concurrent's
			...
			Runnable task = new Runnable() {
				...
				public void run() {
					try {
						...
						// Object result = exchanger.exchange(source, 1L,
						// TimeUnit.SECONDS); // If N==2 and without
						// jpf-concurrent, the timeout causes 149,808 states to
						// be explored.

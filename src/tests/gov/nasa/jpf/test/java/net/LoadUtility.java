...
/**
 * This is used to hide the package "classloader_specific_tests" from JPF which
 * is need to test costum class loaders
 * 
...
public class LoadUtility extends TestJPF {
	...
	protected String jarUrl = "jar:file:" + user_dir + "/build/" + pkg
			+ ".jar!/";

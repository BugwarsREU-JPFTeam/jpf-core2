...
public class URLClassLoaderTest extends LoadUtility {
	...
	public class TestClassLoader extends URLClassLoader {
		...
		public Class<?> delegateTofindSystemClass(String cname)
	...
	@Test
	public void testLoadClass_NoClassDefFoundError()
			throws ClassNotFoundException {
	...
	@Test
	public void testLoadClass_ClassNotFoundException2()
			throws ClassNotFoundException {
		if (verifyUnhandledException("java.lang.ClassNotFoundException")) {
			URL[] urls = new URL[0];
			URLClassLoader cl = new URLClassLoader(urls);
	...
	public void testSystemLoaderLoadClass() throws ClassNotFoundException {
		if (verifyNoPropertyViolation()) {
			...
			assertSame(c1, c2);
			assertSame(c1, c3);
			// this test fails on the host VM, cause java.lang.Class is loaded
			// by
			// bootstrap classloader and therefore c1.getClassLoader() returns
			// null,
	...
	@Test
	public void testFindLoadedClass() throws ClassNotFoundException,
	...
	@Test
	public void testNonSystemLoaderLoadClass() throws MalformedURLException,
		...
		if (verifyNoPropertyViolation()) {
			...
			assertFalse(cls.getClassLoader() == ClassLoader
	...
	public void testFindResources() throws IOException {
		...
		if (verifyNoPropertyViolation()) {
			...
			// we added the same url path twice, but findResource return value
			// should only
	...
	@Test
	public void testNewInstance1() throws MalformedURLException,
			ClassNotFoundException {
		movePkgOut();
		if (verifyNoPropertyViolation()) {
			URL[] urls = new URL[1];
	...
	@Test
	public void testNewInstance2() throws MalformedURLException,
			ClassNotFoundException {
		movePkgOut();
		if (verifyNoPropertyViolation()) {
			URL[] urls = new URL[1];
	...
	@Test
	public void testClassResolution() throws MalformedURLException,
			ClassNotFoundException {
		movePkgOut();
		if (verifyNoPropertyViolation()) {
			// create a url from a dir
	...
	@Test
	public void testFindSystemClass() throws MalformedURLException,
			ClassNotFoundException {
		movePkgOut();
		if (verifyNoPropertyViolation()) {
			URL[] urls = { new URL(dirUrl) };
	...
	@Test
	public void testFindSystemClass_ClassNotFoundException()
		...
		if (verifyUnhandledException("java.lang.ClassNotFoundException")) {
			...
			// this should fail, cause our SystemClassLoader cannot find a
			// non-standard
	...
	@Test
	public void testGetPackages() throws ClassNotFoundException,
			MalformedURLException {
		movePkgOut();
		if (verifyNoPropertyViolation()) {
			URL[] urls = { new URL(dirUrl) };
	...
	@Test
	public void testThrownException() throws ClassNotFoundException,
		...
		if (verifyNoPropertyViolation()) {
			...
			try {
				...
				assertTrue(cause instanceof ArithmeticException
						&& cause.getMessage().equals("division by zero"));
			}
		}
		movePkgBack();
	}

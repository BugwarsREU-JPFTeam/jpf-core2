...
public class DataChoiceTest extends TestJPF {
	...
	public void testIntFromSet() {
		...
		if (verifyNoPropertyViolation(
				"+my_int_from_set.class=gov.nasa.jpf.vm.choice.IntChoiceFromSet",
	...
	public void testIntFromArray() {
		...
		if (verifyNoPropertyViolation()) {
			int i = Verify.getIntFromList(1, 2, 3, 4, 5); // ..and change the
															// combination on my
															// luggage
			System.out.println(i);
			if (i > 0 && i < 6) {
	...
	public void testDoubleFromSet() {
		...
		if (verifyNoPropertyViolation(
				"+my_double_from_set.class=gov.nasa.jpf.vm.choice.DoubleChoiceFromSet",
	...
	public void testTypedObjectChoice() {
		...
		if (verifyNoPropertyViolation(
				"+my_typed_object.class=gov.nasa.jpf.vm.choice.TypedObjectChoice",

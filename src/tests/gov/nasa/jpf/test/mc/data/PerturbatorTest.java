...
public class PerturbatorTest extends TestJPF {
	...
	public void testIntReturnPerturbation() {
		...
		if (verifyNoPropertyViolation(
			...
			x = foo(-1); // this should not be perturbed ('foo' has a location
							// spec)
			...
			case 3:
				...
				break;
			default:
				assert false : "wrong counter 0 (foo() perturbation) value: "
						+ Verify.getCounter(0);
			}
			...
			if (x == 41) {
				...
				case 3:
					...
					break;
				default:
					assert false : "wrong counter 1 (bar() perturbation) value: "
							+ Verify.getCounter(1);
				}
			}
	...
	public void testParamPerturbation() {
		...
		if (verifyNoPropertyViolation(
			...
			if (e == 84) {
				...
				switch (Verify.getCounter(1)) {
				case 1:
					assert Math.abs(d - 0.586) < 0.0001;
					break;
				case 2:
					assert d == 2;
					break;
				...
				case 9:
					...
					break;
				default:
					assert false : "wrong counter value: "
							+ Verify.getCounter(1);
				}
			}
		} else {

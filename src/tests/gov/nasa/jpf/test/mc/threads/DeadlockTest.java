...
public class DeadlockTest extends TestJPF {
	 ...
	 * oldclassic example which has been turned into a test case. as the name
	 * implies - a missed signal deadlock
	 */
	@Test
	...
	/**
	 * the test which checks MONITORENTER / MONITOREXIT simple lock order
	 * deadlock
	 */
	@Test
	...
	/**
	 * the test which checks the synchronized method attribute simple lock order
	 * deadlock
	 */
	@Test

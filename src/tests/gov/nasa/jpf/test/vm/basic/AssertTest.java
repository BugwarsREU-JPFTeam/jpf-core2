...
public class AssertTest extends LoadUtility {
	...
	@Test
	public void testAssertionViolation() {
	...
	@Test
	public void testNoAssertionViolation() {
	...
	public static void invokeAssertFalse(ClassLoader loader, String cname)
	...
	public void testSetClassAssertionStatus1() {
		if (verifyAssertionErrorDetails("oops, assertion failed")) {
			...
			// this should change the "desiredAssertionStatus()" return value to
			// false,
			// but it shouldn't change the actual assertion status since the
			// class has
			// been already initialized
			cl.setClassAssertionStatus("gov.nasa.jpf.test.vm.basic.AssertTest",
					false);
	...
	@Test
	public void testSetClassAssertionStatus2() throws MalformedURLException,
	...
	@Test
	public void testSetPackageAssertionStatus() throws MalformedURLException,
			ClassNotFoundException, SecurityException, NoSuchMethodException,
			IllegalAccessException {
		movePkgOut();
		if (verifyNoPropertyViolation()) {
	...
	@Test
	public void testSetDefaultAssertionStatus() throws MalformedURLException,
			ClassNotFoundException, SecurityException, NoSuchMethodException,
			IllegalAccessException {
		movePkgOut();
		if (verifyNoPropertyViolation()) {
			...
			// shouldn't have any effect on the actual assertion status of the
			// class since
	...
	@Test
	public void testClearAssertionStatus() throws MalformedURLException,
			ClassNotFoundException, SecurityException, NoSuchMethodException,

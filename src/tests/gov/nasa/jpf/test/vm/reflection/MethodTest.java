...
public class MethodTest extends TestJPF {
	...
	public void testInstanceMethodInvoke() {
		if (verifyNoPropertyViolation()) {
			...
			try {
				...
				Method m = cls.getMethod("foo", int.class, double.class,
						String.class);

				Object res = m.invoke(o, new Integer(3), new Double(3.33),
						"Blah");
	...
	public void getPrivateMethod() throws NoSuchMethodException {
		if (verifyUnhandledException(NoSuchMethodException.class.getName())) {
			Integer.class.getMethod("toUnsignedString", int.class, int.class); // Doesn't
																				// matter
																				// which
																				// class
																				// we
	...
	@Test
	public void invokePrivateSameClass() throws NoSuchMethodException,
	...
	@Test
	public void invokePrivateOtherClass() throws NoSuchMethodException,
			IllegalAccessException, InvocationTargetException {
		if (verifyUnhandledException(IllegalAccessException.class.getName())) {
			Method m = Integer.class.getDeclaredMethod("toUnsignedString",
					int.class, int.class);
	...
	@Test
	public void invokePrivateOtherClassAccessible()
	...
	@Test
	public void invokePrivateSuperclass() throws SecurityException,
	...
	@Test
	public void invokeWrongThisType() throws NoSuchMethodException,
			IllegalAccessException, InvocationTargetException {
	...
	@Test
	public void invokeNullObject() throws NoSuchMethodException,
			IllegalAccessException, InvocationTargetException {
	...
	@Test
	public void invokeWrongNumberOfArguments() throws NoSuchMethodException,
			IllegalAccessException, InvocationTargetException {
		if (verifyUnhandledException(IllegalArgumentException.class.getName())) {
			Method m = getClass().getMethod("publicMethod");
	...
	@Test
	public void invokeWrongArgumentTypeReference()
			throws NoSuchMethodException, IllegalAccessException,
			InvocationTargetException {
		if (verifyUnhandledException(IllegalArgumentException.class.getName())) {
	...
	public void testReturnType() {
		if (verifyNoPropertyViolation()) {
			...
			try {
				...
				assert Boo.class.getName().equals(s) : "wrong return type: "
						+ s;

			} catch (Throwable t) {
				t.printStackTrace();

				assert false : " unexpected exception in Method.getReturnType(): "
						+ t;
			}
		}
	}
			...
			try {
				...
				for (Method m : cls.getMethods()) {
					if (m.getName().equals("boofaz")) {
						...
						assert Boo.class.getName().equals(pt[0].getName()) : "wrong parameter type 0: "
								+ pt[0].getName();
						assert Faz.class.getName().equals(pt[1].getName()) : "wrong parameter type 1: "
								+ pt[1].getName();
					}
				}
				...
				assert false : " unexpected exception in Method.getParameterTypes(): "
						+ t;
			}
		}
	}
	...
	static final Object[] testArgValues = { Byte.valueOf((byte) 7),
			Short.valueOf((short) 8), Integer.valueOf(9), Long.valueOf(10),
			Float.valueOf(3.1415f), Double.valueOf(3.14159), Boolean.TRUE,
			Character.valueOf('w'), "hello", null };

	static final Object ILLEGAL = new Object(); // we use this to flag an
	...
	private void invokeTest(Method m, Object argValue, Object expected) {
		...
		try {
			...
			if (isJPFRun()) {
				assertTrue(((ret == null) && (expected == null))
						|| ret.equals(expected));
			}
			...
			fail("_test invocation failed for value = " + argValue + " with "
					+ t);
		}
	}
	...
	public void argTestBoolean() throws NoSuchMethodException {
		if (verifyNoPropertyViolation()) {
			Method m = MethodTest.class.getDeclaredMethod("_test",
					boolean.class);
			Object[] expected = { // all but Boolean throws
			ILLEGAL, ILLEGAL, ILLEGAL, ILLEGAL, ILLEGAL, ILLEGAL, Boolean.TRUE,
	...
	public void argTestByte() throws NoSuchMethodException {
		if (verifyNoPropertyViolation()) {
			...
			Byte.valueOf((byte) 7), ILLEGAL, ILLEGAL, ILLEGAL, ILLEGAL,
	...
	public void argTestShort() throws NoSuchMethodException {
		if (verifyNoPropertyViolation()) {
			...
			Short.valueOf((short) 7), Short.valueOf((short) 8), ILLEGAL,
	...
	public void argTestChar() throws NoSuchMethodException {
		if (verifyNoPropertyViolation()) {
			...
			ILLEGAL, ILLEGAL, ILLEGAL, ILLEGAL, ILLEGAL, ILLEGAL, ILLEGAL,
					Character.valueOf('w'), ILLEGAL, ILLEGAL };
	...
	public void argTestInt() throws NoSuchMethodException {
		if (verifyNoPropertyViolation()) {
			...
			Integer.valueOf(7), Integer.valueOf(8), Integer.valueOf(9),
					ILLEGAL, ILLEGAL, ILLEGAL, ILLEGAL, Integer.valueOf('w'),
					ILLEGAL, ILLEGAL };
	...
	public void argTestLong() throws NoSuchMethodException {
		if (verifyNoPropertyViolation()) {
			...
			Object[] expected = { Long.valueOf(7L), Long.valueOf(8L),
					Long.valueOf(9L), Long.valueOf(10L), ILLEGAL, ILLEGAL,
					ILLEGAL, Long.valueOf('w'), ILLEGAL, ILLEGAL };
	...
	public void argTestFloat() throws NoSuchMethodException {
		if (verifyNoPropertyViolation()) {
			...
			Object[] expected = { Float.valueOf(7f), Float.valueOf(8f),
					Float.valueOf(9f), Float.valueOf(10f),
					Float.valueOf(3.1415f), ILLEGAL, ILLEGAL,
	...
	public void argTestDouble() throws NoSuchMethodException {
		if (verifyNoPropertyViolation()) {
			Method m = MethodTest.class
					.getDeclaredMethod("_test", double.class);
			Object[] expected = { Double.valueOf(7.0), Double.valueOf(8.0),
					Double.valueOf(9.0), Double.valueOf(10.0),
					Double.valueOf(3.1415f), Double.valueOf(3.14159), ILLEGAL,
					Double.valueOf('w'), ILLEGAL, ILLEGAL };
	...
	public void argTestString() throws NoSuchMethodException {
		if (verifyNoPropertyViolation()) {
			Method m = MethodTest.class
					.getDeclaredMethod("_test", String.class);
			Object[] expected = { ILLEGAL, ILLEGAL, ILLEGAL, ILLEGAL, ILLEGAL,
					ILLEGAL, ILLEGAL, ILLEGAL, "hello", null };
	...
	public void argTestObject() throws NoSuchMethodException {
		if (verifyNoPropertyViolation()) {
			Method m = MethodTest.class
					.getDeclaredMethod("_test", Object.class);
	...
	public void argTestNumber() throws NoSuchMethodException {
		if (verifyNoPropertyViolation()) {
			Method m = MethodTest.class
					.getDeclaredMethod("_test", Number.class);
			Object[] expected = { Byte.valueOf((byte) 7),
					Short.valueOf((short) 8), Integer.valueOf(9),
					Long.valueOf(10), Float.valueOf(3.1415f),
					Double.valueOf(3.14159), ILLEGAL, ILLEGAL, ILLEGAL, null // we
																				// already
																				// used
																				// the
																				// real
	...
	public void argTestIntArray() throws NoSuchMethodException {
		if (verifyNoPropertyViolation()) {
			Method m = MethodTest.class.getDeclaredMethod("_test", int[].class);
			Object[] testVals = { new int[0], new float[0], "blah", null };
			Object[] expected = { testVals[0], ILLEGAL, ILLEGAL, null };
	...
	public void testParameterAnnotations() {
		if (verifyNoPropertyViolation()) {
			try {
				...
				/**
				 * mth = cls.getDeclaredMethod("noFoo"); pai =
				 * mth.getParameterAnnotations();
				 * assertTrue("should return Annotation[0][] for noFoo()", pai
				 * != null && pai.length == 0);
				 * 
				 * mth = cls.getDeclaredMethod("noFoo", int.class ); pai =
				 * mth.getParameterAnnotations();
				 * assertTrue("should return Annotation[1][{}] for noFoo(int)",
				 * pai != null && pai.length == 1 && ((pai[0] != null) &&
				 * (pai[0].length == 0))); System.out.println("noFoo(int) : " +
				 * pai[0]);
				 **/
				mth = cls.getDeclaredMethod("oneFoo", int.class);
				pai = mth.getParameterAnnotations();
				assertTrue(
						"should return Annotation[1][{@A}] for oneFoo(int)",
						pai != null
								&& pai.length == 1
				...
				pai = mth.getParameterAnnotations();
				assertTrue(
						"should return Annotation[1][{@A}{}] for twoFoo(int,int)",
						pai != null
								&& pai.length == 2
								&& ((pai[0] != null) && (pai[0].length == 0))
								&& ((pai[1] != null) && (pai[1].length == 1) && (pai[1][0] instanceof A)));
				System.out.println("twoFoo(int, @A int)  : " + pai[0] + ','
						+ pai[1][0]);

...
/**
 * just the very basic sanity checks for a hash function. <2do> should add a
 * test for uniformity of hash vals and measure collisions in medium bin size
 * constraints
 */
public class OATHashTest extends TestJPF {
	...
	public void testRandom() {
		...
		HashSet<Integer> seen = new HashSet<Integer>(); // not very smart, but

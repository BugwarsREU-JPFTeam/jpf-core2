...
public class SparseClusterArrayTest extends TestJPF {
	...
	public void testClusterNextNull() {
		...
		int r = arr
				.firstNullIndex(base, SparseClusterArray.MAX_CLUSTER_ENTRIES);
		assert r == 0x02000000;
	...
	public void testSnapshot() {
		...
		int len = snap.size();
		for (int i = 0; i < len; i++) {
			System.out.println("a[" + snap.getIndex(i) + "] = "
					+ snap.getValue(i));
		}
	...
	public void testIterator() {
		...
		assert n == 451 : "wrong number of visited elements: " + n; // [0-200] +
																	// [750-999]
	...
	public void testIndexIterator() {
		...
		assert n == 351 : "wrong number of visited elements: " + n; // [100-200]
																	// +
																	// [750-999]
		assert lastSeen : "last element not seen";
	}
	...
	static void evalSparseClusterArray() {
		...
		System.out.println("SparseArray random write/read of "
				+ arr.cardinality() + " elements: " + (t2 - t1));
		...
		t2 = System.currentTimeMillis();
		System.out.println("SparseArray iteration over " + n + " elements: "
				+ (t2 - t1));
	}
	...
	static void evalHashMap() {
		...
		t2 = System.currentTimeMillis();
		System.out.println("HashMap random write/read of " + arr.size()
				+ " elements: " + (t2 - t1));
		...
		t2 = System.currentTimeMillis();
		System.out.println("HashMap iteration over " + n + " elements: "
				+ (t2 - t1));
	}
}
